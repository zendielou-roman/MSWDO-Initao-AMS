  ...
  services: {
    ...
    items: {
      aics: {
        ...
        benefits: ['Pinansyal at materyal na tulong', 'Pagre-refer sa iba pang serbisyo', 'Pagsusuri at follow-up batay sa kaso'],
        requirements: ['Pangunahing ID na inilabas ng gobyerno', 'Sertipikasyon o Referral mula sa Barangay', 'Mga pansuportang dokumento batay sa kaso'],
        process: [
          { title: 'Pagsusuri', body: 'Sinusuri ng social worker ang sitwasyon upang matukoy ang uri ng tulong na kinakailangan.' },
    ...
    detail: {
      ...
      getDirections: 'Direksyon at Impormasyon sa Pakikipag-ugnayan',
