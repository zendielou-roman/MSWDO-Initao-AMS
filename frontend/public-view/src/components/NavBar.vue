  ...
  <div class="sticky top-0 z-[100] bg-[#e9ebee] px-8 pt-[0.9rem] pb-[0.4rem]">
    ...
    >
      <div class="flex items-center gap-[1.1rem]">
        ...
        <ul class="flex flex-wrap items-center gap-x-16 gap-y-2 list-none m-0 p-0">
          <li
            v-for="link in links"
            :key="link.label"
            class="relative flex"
          ...
          >
            <a
              href="#"
              class="inline-flex items-center gap-[3px] text-[0.82rem] font-bold tracking-[0.5px] leading-none text-[#1f3a63] no-underline pb-1 border-b-[3px] border-transparent transition-colors hover:text-[#d4a526]"
              :class="{ '!border-[#1f3a63]': active === link.sectionId }"
