  ...
  // Sections beyond Dashboard aren't built yet — listed here so the sidebar shows the
  // full OIC navigation from the prototype, but they render as disabled placeholders
  // (no route) until each page is built one at a time.
  const upcomingSections = [
    { label: 'Clients & Beneficiaries', icon: Users },
        ...
        >
          <div class="flex items-center gap-3 overflow-hidden">
            ...
            <div v-if="!isCollapsed" class="leading-tight whitespace-nowrap">
              ...
              <p class="text-[11px] text-amber-400">Officer-in-Charge</p>
            </div>
          </div>
      ...
      <div class="flex flex-1 flex-col overflow-y-auto">
        ...
        >
          <div>
            ...
            <p class="text-sm text-slate-400">Officer-in-Charge · {{ today }}</p>
          </div>
          ...
          <div class="flex items-center gap-4">
            ...
            <!-- OIC notifications page isn't built yet — icon shown for layout parity, not clickable -->
